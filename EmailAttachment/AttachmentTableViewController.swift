...
class AttachmentTableViewController: UITableViewController, MFMessageComposeViewControllerDelegate {
    ...
    // required method to implement MFMessageComposeViewControllerDelegate
    ...
    func sendSMS(attachment: String) {
        // check if the device is capable of sending a text message
        ...
        messageController.recipients = ["12345678, 98765432"]
